function [ x_true, x1, dx1_abs, dx1_rel, ...
                   x2, dx2_abs, dx2_rel ] = ...
     generate_observations_fig_s2( x_true_original, ...
                            uncertainties1, dx1_bias, ...
                            uncertainties2, dx2_bias)

%FUNCTION generate_observations_fig_s2(x_true_original, ...
%                               uncertainties1, dx1_bias, ...
%                               uncertainties2, dx2_bias)
%
...
% This is exactly the same function as generate_observations() except that
% this chooses the MODIS-like uncertainty definition. This is used only
% with fig_s2.m
%
%INPUT:
